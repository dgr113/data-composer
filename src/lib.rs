...
impl ComposerApi {
    ...
    ///
    pub fn get_full(coll: &Collection, app_type: &str, lang: &str, update: Option<bool>, config: &HashMap<String, String>, filter: Option<&serde_json::Value>)
        -> ResultParse<Vec<serde_json::Value>>
        {
            ...
            ComposerIntro::get_full(coll, tree_params, brief_params, update, filter)
        }
